...
export const updateDocStatusSchema = Joi.object({
  document_id: Joi.string().regex(objectIdRegex).required().messages({
...
export const updateActionSchema = Joi.object({
  ...
  document_approval: Joi.string().required().messages({
...
export const addDpSchema = Joi.object({
  ...
  vehicle_type: Joi.string().trim().allow("", null),
  aadhar_number: Joi.string().trim().allow("", null),
  rc_number: Joi.string().trim().allow("", null),
  dl_number: Joi.string().trim().allow("", null),
  bank_name: Joi.string().trim().allow("", null),
  bank_acc_number: Joi.string().trim().allow("", null),
  bank_ifsc: Joi.string().trim().allow("", null),
  vehicle_number: Joi.string().trim().allow("", null),
  reference1_name: Joi.string().trim().allow("", null),
  reference1_phone: Joi.string().trim().allow("", null),
  reference2_name: Joi.string().trim().allow("", null),
  reference2_phone: Joi.string().trim().allow("", null),
  dl_expiry_date: Joi.string().allow("", null),
  sub_vehicle_type: Joi.string().allow("", null),
  other_vehicle_details: Joi.string().allow("", null),
  vehicle_min_capacity: Joi.any().allow("", null),
  vehicle_max_capacity: Joi.any().allow("", null),
  insurance_expiry_date: Joi.string().allow("", null),
  emission_expiry_date: Joi.string().allow("", null),
  is_new_vehicle: Joi.any().allow("", null),
  vehicle_registration_date: Joi.string().allow("", null),
  travel_permit_states: Joi.string().allow("", null),
  permit_expiry: Joi.string().allow("", null),
});
...
export const addPdcSchema = Joi.object({
  ...
  aadhar: Joi.string().trim().allow("", null),
  gst: Joi.string().trim().allow("", null),
  pan: Joi.string().trim().allow("", null),
  bank_name: Joi.string().trim().allow("", null),
  bank_ifsc: Joi.string().trim().allow("", null),
  bank_acc_no: Joi.string().trim().allow("", null),
  password: Joi.string().required().messages({
    "string.empty": "Password is required",
    "any.required": "Password is required",
  }),
...
export const assignDeliveryboySchema = Joi.object({
  ...
  dp_id: Joi.string().regex(objectIdRegex).required().messages({
...
const deliverChargeItemSchema = Joi.object({
  ...
  base_distance: Joi.number().required().messages({
  ...
  per_km_price: Joi.number().required().messages({
  ...
  dp_commission: Joi.number().required().messages({
    "number.base": "DP commission must be a number",
    "any.required": "DP commission is required",
  }),
  pdc_commission: Joi.number().required().messages({
...
export const sendOtpSchema = Joi.object({
  ...
  action_type: Joi.string().required().messages({
  ...
  credentialsToken: Joi.string().required().messages({
...
export const creditIndividualSchema = Joi.object({
  wallet_id: Joi.string().regex(objectIdRegex).required().messages({
...
export const addVehicleSubcategorySchema = Joi.object({
  vehicle_type: Joi.string()
    ...
    .messages({
      ...
      "any.only":
        "Vehicle type must be one of: By Hand, Two Wheeler, Three Wheeler, Four Wheeler",
      "any.required": "Vehicle type is required",
    }),
  sub_vehicle_type: Joi.string().trim().required().messages({
