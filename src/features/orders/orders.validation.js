...
export const createOrderSchema = Joi.object({
  ...
  how_to_reach_sender_location: Joi.string()
    .trim()
    .allow('', null),
  ...
  how_to_reach_receiver_address: Joi.string()
    .trim()
    .allow('', null),
  distance: Joi.number()
    .required()
...
export const cancelOrderSchema = Joi.object({
  ...
  cancel_order_reason: Joi.string()
    .trim()
    .required()
    .messages({
